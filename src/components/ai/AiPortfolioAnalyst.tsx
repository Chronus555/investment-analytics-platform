...
export function AiPortfolioAnalyst({
  ...
  return (
    <div className="w-full bg-white border border-slate-200 rounded-xl p-5 shadow-xs space-y-4">
      {/* Header */}
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="font-semibold text-base text-slate-900 flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 bg-emerald-50 border border-emerald-200 text-emerald-700 text-[10px] rounded-full font-mono font-medium">
                Engine Grounded
              </span>
            </h3>
      ...
      <div className="flex flex-wrap items-center gap-1.5 pt-1">
        ...
        {quickQuestions.map((q) => (
          <button
            ...
            className="text-[11px] px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md border border-slate-200 transition-all text-left cursor-pointer"
          >
            {q}
          </button>
        ))}
      ...
      <div className="flex items-center gap-2 pt-2">
        <input
          ...
          className="flex-1 bg-white border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 focus:outline-none font-sans"
        />
        <button
          type="button"
